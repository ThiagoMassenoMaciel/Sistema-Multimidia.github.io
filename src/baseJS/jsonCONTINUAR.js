const data = [
  {
    ...
    exposicao_artistas: [
      ...
      },
      {
        ...
        obras: [
          {
            nome: ["El Jardín de las Delicias"],
            url_imgagens: {
              url_img_obra: "",
              url_outrasFotos: [],
            },
  ...
  {
    id: 2,
    nome_museum: "Museu do Louvre",
    cidade: "Paris",
    pais: "França",
    image_museum: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Le_Louvre_-_Aile_Richelieu.jpg/1200px-Le_Louvre_-_Aile_Richelieu.jpg",
      "https://www.visitparisregion.com/imageresizer/?image=https%3A%2F%2Fwww.visitparisregion.com%2Fvar%2Ffichiers%2Fimages%2Fmediatheque%2Flouvre-pyramide-de-louvre-paris-visitparisregion-960x640.jpg&action=ProductDetail-1920x1080-fit&width=1200&height=675",
      "https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/ed/8e/1a.jpg",
      "https://www.france.fr/sites/default/files/2020-01/Musee-du-Louvre.jpg",
    ],
    url_video_museum: [],
    descricao_museum:
      "O Museu do Louvre, localizado em Paris, França, é um dos museus de arte mais famosos e visitados do mundo. Fundado em 1793, o Louvre abriga uma vasta coleção de obras de arte que abrangem desde a antiguidade até o século XIX. Entre suas peças mais icônicas estão a Mona Lisa de Leonardo da Vinci, a Vênus de Milo e a Vitória de Samotrácia. O museu é conhecido por sua arquitetura impressionante, incluindo a famosa pirâmide de vidro na entrada principal. Com milhões de visitantes anualmente, o Louvre é um centro cultural que celebra a história da arte e a criatividade humana.",
    exposicao_artistas: [
      {
        nome: "Leonardo da Vinci",
        obras: ["Mona Lisa", "A Última Ceia", "A Virgem das Rochas"],
      },
      {
        nome: "Michelangelo Buonarroti",
        obras: ["A Criação de Adão", "O Juízo Final", "Davi"],
      },
      {
        nome: "Raphael Sanzio",
        obras: ["A Escola de Atenas", "A Transfiguração", "Madona Sistina"],
      },
      {
        nome: "Titian (Tiziano Vecellio)",
        obras: ["Assunção da Virgem", "Vênus de Urbino", "Baco e Ariadne"],
      },
      {
        nome: "Caravaggio (Michelangelo Merisi)",
        obras: [
  ...
  {
    id: 3,
    nome_museum: "Museu Metropolitano de Arte",
    cidade: "Nova York",
    pais: "Estados Unidos",
    image_museum: [
      "https://www.metmuseum.org/-/media/images/visit/met-fifth-avenue/fifthave_teaser.jpg",
      "https://www.metmuseum.org/-/media/images/visit/met-fifth-avenue/fifthave_entrance.jpg",
      "https://www.metmuseum.org/-/media/images/visit/met-fifth-avenue/fifthave_rooftop_garden.jpg",
      "https://www.metmuseum.org/-/media/images/visit/met-fifth-avenue/fifthave_galleries.jpg",
    ],
    url_video_museum: [],
    descricao_museum:
      "O Museu Metropolitano de Arte, conhecido como The Met, está localizado em Nova York, Estados Unidos. Fundado em 1870, é um dos maiores e mais importantes museus de arte do mundo. O Met abriga uma vasta coleção que abrange mais de 5.000 anos de história da arte, incluindo obras de diversas culturas e períodos, desde a antiguidade até a arte contemporânea. Entre suas coleções mais notáveis estão pinturas europeias, arte egípcia, arte asiática e arte americana. O museu é conhecido por sua arquitetura impressionante e por ser um centro cultural que atrai milhões de visitantes anualmente.",
    exposicao_artistas: [
      {
        nome: "Vincent van Gogh",
        obras: ["A Noite Estrelada", "Girassóis", "O Quarto em Arles"],
      },
      {
        nome: "Claude Monet",
        obras: ["Impressão, Nascer do Sol", "Nenúfares", "A Catedral de Rouen"],
      },
      {
        nome: "Pablo Picasso",
        obras: ["Guernica", "Les Demoiselles d'Avignon", "O Velho Guitarrista"],
      },
    ],
  },
  {
    id: 4,
    nome_museum: "Museu Britânico",
    cidade: "Londres",
    pais: "Reino Unido",
    image_museum: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/British_Museum_from_NE_2.JPG/1200px-British_Museum_from_NE_2.JPG",
      "https://www.britishmuseum.org/sites/default/files/2020-11/British_Museum_exterior_0.jpg",
      "https://www.britishmuseum.org/sites/default/files/2020-11/British_Museum_Great_Court_0.jpg",
      "https://www.britishmuseum.org/sites/default/files/2020-11/British_Museum_Rosetta_Stone_0.jpg",
    ],
    url_video_museum: [],
    descricao_museum:
      "O Museu Britânico, localizado em Londres, Reino Unido, é um dos museus mais antigos e renomados do mundo. Fundado em 1753, o museu abriga uma vasta coleção de artefatos históricos e culturais que abrangem mais de dois milhões de anos de história humana. Entre suas peças mais famosas estão a Pedra de Roseta, as esculturas do Partenon e a múmia de Katebet. O Museu Britânico é conhecido por sua arquitetura impressionante e por ser um centro de pesquisa e educação, atraindo milhões de visitantes anualmente.",
    exposicao_artistas: [
      {
        nome: "Auguste Rodin",
        obras: ["O Pensador", "O Beijo", "A Porta do Inferno"],
      },
      {
        nome: "J.M.W. Turner",
        obras: [
